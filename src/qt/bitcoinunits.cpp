...
{
    switch (unit) {
    case Unit::BTC: return QString("BTCBT");
    case Unit::mBTC: return QString("mBTCBT");
    case Unit::uBTC: return QString::fromUtf8("µBTCBT (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("BitcoinBT (BTCBT)");
    case Unit::mBTC: return QString("Milli-BitcoinBT (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BitcoinBT (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
